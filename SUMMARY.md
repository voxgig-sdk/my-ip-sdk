...
Results: Successful response with IP address information.
...
| --- | --- | --- | --- |
| GetIpInfo | `load` | `GET /` | See reference |

## Connect to the API

- Production server: `https://api.miip.my`
...
- `my-ip_list`: List records for an entity. No active entity supports this operation.
- `my-ip_load`: Load one record for an entity. Supported entities: `get_ip_info`.
