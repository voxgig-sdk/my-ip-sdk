...
(0, node_test_1.describe)('GetIpInfoDirect', async () => {
    ...
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('MY_IP_TEST_LIVE'));
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.MyIpSDK({
...
function liveScenariosActive() { return false && process.env.MY_IP_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.MyIpSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['MY_IP_TEST_GET_IP_INFO_ENTID'];
