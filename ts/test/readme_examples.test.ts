...
//     (\`new MyIpSDK(...)\` / \`MyIpSDK.test(...)\` become
//     \`MyIpSDK.test({ entity: ... })\`), transpiled to JS, and run
...
// rewrite real client construction (\`new MyIpSDK(...)\` and any
// \`MyIpSDK.test(...)\`) to a seeded test-mode client, and give
