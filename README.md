...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/my-ip` | `npm install @voxgig-sdk/my-ip` |
| Python | `voxgig-sdk-my-ip` | `pip install voxgig-sdk-my-ip` |
| PHP | `voxgig-sdk/my-ip` | `composer require voxgig-sdk/my-ip` |
| Golang | `github.com/voxgig-sdk/my-ip-sdk/go` | `go get github.com/voxgig-sdk/my-ip-sdk/go` |
| Ruby | `voxgig-sdk-my-ip` | `gem install voxgig-sdk-my-ip` |
| Lua | `voxgig-sdk-my-ip` | `luarocks install voxgig-sdk-my-ip` |
