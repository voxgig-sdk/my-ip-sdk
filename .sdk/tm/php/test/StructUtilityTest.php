...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = MyIpOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(MyIpOmni::structfix($now, Struct::undef()))
                        !== json_encode(MyIpOmni::structfix($val, Struct::undef()))) {
