...
|---|---|---|
| `ts/` | @voxgig-sdk/my-ip-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/my-ip-sdk \
      --repository voxgig-sdk/my-ip-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/my-ip-sdk` shows it, and
`npm trust revoke @voxgig-sdk/my-ip-sdk --id=<id>` removes it.
