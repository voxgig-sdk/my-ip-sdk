...
class MyIpTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = MyIpTestRunner.getenv("MY_IP_TEST_LIVE")
        override = MyIpTestRunner.getenv("MY_IP_TEST_OVERRIDE")
        ...
        explain = MyIpTestRunner.getenv("MY_IP_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["MY_IP_TEST_EXPLAIN"] = explain
...
def live_client_options():
    return MyIpTestRunner.live_client_options()
